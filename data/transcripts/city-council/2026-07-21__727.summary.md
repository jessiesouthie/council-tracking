...
*Minutes would say:* The council approved the second amendment to the Triumph master development agreement with conditions. *Recording captures:* Nearly ninety minutes across two sessions in which council members read the deed restriction line by line — catching a wrong word, duplicated section numbers, cross-references pointing at the wrong article, and a misspelling of "foreclosure" — and haggled over whether the city's share of water costs should be pegged to its own rate or to a market that Hazard said has hit $35,000 an acre-foot. The final motion was so long the chair called it "a very fastidious motion," and Wood had to stop the chair from moving on before he finished reading it.

*Minutes would say:* Three residents spoke during public comment regarding traffic safety. *Recording captures:* A near-miss with a motorcycle the previous night, a gun pulled during a neighbor's argument over speeding, three children struck in one neighborhood, a father describing the death grip he keeps on his six-year-old, and a resident who fixed the car of the young driver who tore up his driveway. It also captures the council's split reaction — an explanation of the $200,000 already budgeted, a shrug about the pace of government, and a colleague calling that shrug a lie.

*Minutes would say:* The council received a presentation on wildland urban interface standards; no action taken. *Recording captures:* An unresolved argument about fairness. Wood pressed the point that a homeowner forced to clear a buffer gets nothing back when the vacant land behind them is developed and the designation disappears — "are they going to be reimbursed when it gets built up against them? The answer is no" — while Huish argued the burden belongs to whoever owns the empty land, and Wright kept returning to whether the city should impose safety rules the state never asked for.
